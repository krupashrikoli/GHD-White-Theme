    ...
    <div className="bg-cream min-h-screen flex flex-col">
      <section className="flex-1 section-pad pt-28 sm:pt-32 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <h2
            className="font-display text-charcoal text-xl sm:text-2xl mb-6 text-center sm:text-left"
            style={{ fontFamily: "Instrument Serif, Georgia, serif" }}
          >
            Open positions
          </h2>
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-5 mb-14 sm:mb-16">
            {JOB_POSTINGS.map((job) => (
              <article
                key={job.id}
                className="rounded-2xl border border-gold/15 bg-cream-deep/25 p-5 sm:p-6 flex flex-col"
              >
                <h3
                  className="font-display text-charcoal text-lg sm:text-xl mb-2"
                  style={{ fontFamily: "Instrument Serif, Georgia, serif" }}
                >
                  {job.title}
                </h3>
          ...
          <div className="rounded-2xl border border-gold/15 bg-cream-deep/25 p-5 sm:p-8 md:p-10">
            <h2
              className="font-display text-charcoal text-xl sm:text-2xl mb-2"
              style={{ fontFamily: "Instrument Serif, Georgia, serif" }}
            >
              Apply
            </h2>
                ...
                <div className="space-y-5 max-w-xl">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full text-sm text-charcoal/80 file:mr-4 file:rounded-lg file:border-0 file:bg-gold/20 file:px-4 file:py-2 file:text-sm file:font-medium file:text-charcoal hover:file:bg-gold/30 cursor-pointer"
