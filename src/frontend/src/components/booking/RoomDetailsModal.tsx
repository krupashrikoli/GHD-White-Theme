        ...
        <div className="flex max-h-[calc(100vh-2.5rem)] flex-col">
          <div className="flex items-center justify-between border-b border-charcoal/10 px-5 py-4 sm:px-8">
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-charcoal/15 text-charcoal/70 transition hover:bg-cream/5 hover:text-charcoal"
              aria-label="Close"
            >
                ...
                <div className="rounded-xl border border-charcoal/10 bg-white/60 p-3">
                  ...
                  >
                    ...
                    <div className="absolute inset-y-0 left-0 flex items-center px-2">
                      <button
                        type="button"
                        className="h-9 w-9 rounded-full bg-black/40 border border-white/10 text-white/90 flex items-center justify-center hover:bg-black/55 transition"
