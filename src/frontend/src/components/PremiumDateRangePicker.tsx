      ...
      >
        <div className="mb-3 flex items-center justify-between gap-2">
          <button
            ...
            className={`flex h-8 w-8 items-center justify-center rounded-full border border-gold/35 transition ${
              prevDisabled
          ...
          >
            <ChevronLeft className="h-3.5 w-3.5 text-charcoal/75" />
          </button>
          ...
          <div className="text-center">
            ...
            <p className="text-[0.62rem] uppercase tracking-[0.2em] text-charcoal/55">
          ...
          <button
            type="button"
            onClick={() => setMonth((m) => addMonths(m, 1))}
            className="flex h-8 w-8 items-center justify-center rounded-full border border-gold/35 transition hover:bg-gold/15"
            aria-label="Next month"
          >
            <ChevronRight className="h-3.5 w-3.5 text-charcoal/75" />
          </button>
        </div>

        <div className="mb-1.5 grid grid-cols-7 gap-1 text-center sm:gap-1.5">
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((d) => (
            <div
              key={d}
              className="py-0.5 text-[0.55rem] uppercase tracking-[0.18em] text-charcoal/55"
          ...
          {grid.map((d) => {
            ...
            return (
              <button
                ...
                className={[
                  "flex h-8 w-full items-center justify-center text-xs transition sm:h-9",
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          <button
            type="button"
            className="text-[0.65rem] uppercase tracking-[0.18em] text-charcoal/60 transition hover:text-charcoal"
            onClick={() => {
          ...
          <button
            type="button"
            className="btn-gold-filled !min-h-0 flex h-8 min-h-8 items-center justify-center px-4 py-0 text-[0.65rem] font-semibold tracking-[0.1em]"
